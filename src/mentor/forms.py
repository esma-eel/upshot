...
class MentorSettingForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "social_media_link": forms.URLInput(
                attrs={
                    "class": (
                        "form-control rounded-pill p-4 text-center text-muted"
                    )
            ...
            "active": forms.Select(
                attrs={
                    "class": (
                        "custom-select rounded-pill text-center text-muted"
                    )
                }
            ),
        }
        ...
        help_texts = {
            ...
            "email": _(""),
            "social_media_link": _(
                "لینک شبکه اجتماعی که از طریق آن با شاگرد خود میخواهید"
                " ارتباط برقرار کنید"
            ),
            "phone_number": _("این مورد اختیاری میباشد"),
            "extra_info": _(
                "اطلاعات بیشتر درباره زمینه‌ی فعالیت و اینکه چه کار"
                " هایی برای شاگردان خود میکنید و ..."
            ),
        }
